...
<html lang="en">
<head>
  <title>les statistiques de naissances </title>
  <meta charset="utf-8">
            ...
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">COMMUNE D'ARRONDISSEMENT DE BAFOUSSAM 1 <sup>er</sup></span>
                <div class="spinner-grow text-success" role="status" style="width: 10px; height: 10px;">
                    <span class="visually-hidden">STATISTIQUE...</span>
                      </div>
            </a>
  ...
  <div class="content-wrapper" >
      ...
      <div class="card">
        <div class="card-header">
          <h5 align="center"><b>VARIATION STATISTIQUE DES DECLARATION ET TRAITEMENT</b></h2>
        </div>
        <div class="card-body">
              ...
              <table id="example" class="table table-striped table-bordered" style="width:100%">           
                <thead style="color: green;">
                  <tr>
                    ...
                    <th>mois</th>
                        <th>nombre refuser</th>
                        <th>nombre valide</th>
                        <th>nombre en entente</th>
                        <th>total</th>
