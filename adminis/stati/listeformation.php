...
<body style="background-image: url(eau1.jpg);">
  ...
  $listeformation="SELECT idformation, codeformation, libelleformation, region, departement, arrondissement FROM formationsanitaire";
  $sql=mysqli_query($conn,$listeformation);
    ...
    ?>
      ...
      <div class="card">
        <div class="card-header">
          <h5 align="center"><b>LISTE DES FORMATIONS SANITAIRES</b></h2>
        </div>
        <div class="card-body">
          <form method="POST" action="">
          
              <table id="example" class="table table-striped table-bordered" style="width:100%">           
                <thead style="color: green; background-color:lightblue;">
                  <tr>
                    <th>libelle</th>
                    <th>CODE</th>
                    <th>departement</th>
                ...
                <tbody>
                  <?php foreach ($sql as $key): ?>
                   ...
                   <tr align="center">
                    ...
                    <td><?= $key['libelleformation'];?></td>
                    <td><?= $key['codeformation'];?></td>
                    ...
                    <td align="right" >
                      ...
                      <a href="deleteform.php?idform=<?= $key['idformation'];?>" style="color:white;" class="btn btn-danger">
                        <i class="fas fa-trash-alt" style="height: 15px;"></i>
                      </a>
                      <a href="modifieform.php?idform=<?= $key['idformation'];?>" style="color:white; padding-left: 15px;"class="btn btn-info">
