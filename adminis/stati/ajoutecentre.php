              ...
              <div class="col-6">
                <div class="card">
                  <div class="card-header">
                    <h3 style="font-style:oblique;">ajouter un nouveau centre</h3>
                  </div>
                  <div class="card-body"> 
                    <form method="POST" action="">
                    <div>
                      <label>nom du centre</label>
                      <input type="text" name="libelle" class="form-control" style="font-style: italic;">
                    </div>
                      <div>
                      ...
                      <select name="arrondissement" class="form-control">
                        <option value="bafoussam1">Bafoussam 1 <sup>er</sup></option>
                      </select>
                      </div>
                                          
                      <div>
                      <label>collectivite local</label>
                      <select name="local" class="form-control">
                <option value="commune de bafoussam 1">commune de bafoussam 1</option>
                      </select>
                      </div>
                      <input type="submit" name="centre" class="btn btn bg-success" value="save">
...
if (isset($_POST['centre'])) {
  ...
  //sauvergade des information dans la table centre  d etat civil base de donnee daknaiss
$conn=mysqli_connect("localhost","root","","daknaiss");
  $centre="INSERT INTO centredetat(idcentre, codecentre, colllectivitelocal, libelle, region, departement, arrondissement) VALUES  (null,'$code','$local','$libelle','$region','$departement','$arrondissement')";

  $format=mysqli_query($conn,$centre);
