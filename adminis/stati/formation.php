    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12" align="center" style="background-color: white; color: green;">
              <?php 
              ...
              <div class="col-6">
                <div class="card">
                  <div class="card-header">
                    <h3 style="font-style:oblique;">ajouter une formation sanitaire</h3><i class="fas fa-hospital-symbol"></i>
                  </div>
                  <div class="card-body"> 
                    <form method="POST" action="">
                    <div>
                      <label>nom de la formation</label>
                      <input type="text" name="libelle" class="form-control" style="font-style: italic;" required>
                    </div>
                      <div>
                      <label>code de la formation</label>
                    ...
                    <div>
                      ...
                      <input type="submit" name="formation" class="btn btn bg-success" value="save">
                      <input type="reset" name="non" class="btn btn bg-danger" value="annuler">
...
if (isset($_POST['formation'])) {
  ...
  //sauvergade des information dans la table formation sanitaire base de donnee daknaiss
$conn=mysqli_connect("localhost","root","","daknaiss");
  $forma="INSERT INTO formationsanitaire(idformation, codeformation, libelleformation, region,departement, arrondissement) VALUES (null,'$code','$libelle','$region','$departement','$arrondissement')";
  $format=mysqli_query($conn,$forma);
