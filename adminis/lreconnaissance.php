...
<head>
  ...
  <title>liste de reconnaissance de parterniter</title>
  <!-- base:css -->
...
<body style="background-image: url(eau1.jpg);">
            ...
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">COMMUNE D'ARRONDISSEMENT DE BAFOUSSAM 1 <sup>er</sup></span>
                <div class="spinner-grow text-success" role="status" style="width: 10px; height: 10px;">
                    <span class="visually-hidden">LRECONNU...</span>
                      </div>
            </a>
  ...
  <div class="main-panel" >
    ...
    <?php 
      ...
      $liste="SELECT enfant.*,declaration.iddeclaration FROM declaration,reconnaissance,actenaissance,enfant WHERE reconnaissance.idacte=actenaissance.idacte AND actenaissance.iddeclaration=declaration.iddeclaration AND enfant.idenfant=declaration.idenfant";
     ...
     ?>
      <div class="card">
        <div class="card-header">
          <h5 align="center"><b>LISTE D'ENFANT NE(E) HORS MARIAGE RECONNU</b></h2>
        </div>
        <div class="card-body">
                ...
                <tbody>
                  <?php foreach ($tliste as $key): ?>
                   ...
                   <tr>
                    ...
                    <td align="right" >
            <a href="apercur.php?declaration=<?=$key['iddeclaration'];?>"align="center" class="btn btn-primary">
