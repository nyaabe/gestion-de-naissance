...
<body style="background-image: url(eau1.jpg);">
            ...
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">COMMUNE D'ARRONDISSEMENT DE BAFOUSSAM 1 <sup>er</sup></span>
                <div class="spinner-grow text-success" role="status" style="width: 10px; height: 10px;">
                    <span class="visually-hidden">LISTE ACTE</span>
                      </div>
            </a>
  ...
  <div class="content-wrapper" >
    ...
    <?php 
      ...
      $liste="SELECT enfant.*,declaration.iddeclaration FROM declaration ,enfant WHERE declaration.idenfant=enfant.idenfant and declaration.statut='valide'";
     ...
     ?>
      <div class="card">
        <div class="card-header">
          <h5 align="center"><b>LISTE DES ACTES ETABLIS</b></h2>
        </div>
        <div class="card-body">
                ...
                <tbody>
                  <?php foreach ($tliste as $key): ?>
                   ...
                   <tr>
                    ...
                    <td align="right" >
            <a href="../acte/acte2.php?acte=<?=$key['iddeclaration'];?>"align="center" class="btn btn-primary">
